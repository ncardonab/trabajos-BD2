...
public class ConexionBD extends JFrame {
	...
	public void insertarCiudad(String ciudad, String locales) {
		// Estableciendo la conexi�n con la base de datos
		this.Conexion();
		...
		// Creando query para inserci�n
		String queryInsertCity = "INSERT INTO CITY (Nombre_ciudad,Locales) VALUES ('" + ciudad + "',XMLTYPE('" + xml
				+ "'))";

		// Si salta un excepci�n de que se viola una restricci�n de clave �nica
	...
	public int getLocalsCount(String city) {
		...
		// n�mero de rectangulos que hay en una ciudad, b�sicamente el n�mero de locales
		try {
			sentencia = conn.createStatement();
